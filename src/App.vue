...
<template>
	<div class="site-shell" :class="{ 'docs-mode': readerOpen }">
		<GlobalTopbar @open-doc="openReader" @go-home="goHome" />
			...
			<section class="hero section-wrap">
				<div class="hero-copy">
					...
					<div class="hero-actions"><a class="glass-button blue large" href="https://j2agent.jerryt92.top/" target="_blank"
						...
						<button class="glass-button blue docs-entry" type="button" @click="openReader">
		...
		/>
		<section v-show="readerOpen" id="docs" class="reader-overlay" aria-label="J2Agent 文档中心">
